...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "homework7:16340164", NULL, NULL);
	if (window == NULL) {
	...
	Shader depthShader("vdepthShader.txt", "fdepthShader.txt");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		ImGui::RadioButton("orthogonal", &radio, 0);
		ImGui::RadioButton("perspective", &radio, 1);

		ImGui::SliderFloat("lightx", &lightPos.x, -5.0f, 5.0f);
		ImGui::SliderFloat("lighty", &lightPos.y, 0.0f, 10.0f);
		ImGui::SliderFloat("lightz", &lightPos.z, -5.0f, 5.0f);

		ImGui::SliderFloat("orth_near_plane", &near_plane, 1.0f, 10.0f);
		ImGui::SliderFloat("orth_far_plane", &far_plane, 1.0f, 15.0f);
		...
		depthShader.setMat4("model", model);
		depthShader.setVec3("objectColor", 0.0f, 0.0f, 1.0f);
		//cube
		...
		shader.use();
		glm::mat4 projection = glm::perspective(camera.Zoom, (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.01f, 100.0f);
